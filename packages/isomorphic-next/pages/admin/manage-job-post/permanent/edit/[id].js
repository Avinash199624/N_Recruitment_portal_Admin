...
const JobPostPermanentUpdate = () => {
  ...
  const handleOnChangePosition = (value, key, name) => {
    ...
    manpower_positions[key].position = selectedPositionData[0].perm_position_master?.position_display_name;
    ...
    manpower_positions[key].quota = selectedPositionData[0].perm_position_master?.quota;
  ...
  return (
    <>
      <Head>
        <title>Update Permanent Jobs</title>
      </Head>
      <DashboardLayout>
        <LayoutContentWrapper>
          <ManageJobPostStyles>
            <FormStyles>
              <PageHeader>Update Permanent Jobs</PageHeader>
                ...
                <Col span={24}>
                  <Row justify='end'>
                    <Button
                      ...
                      onClick={() => {
                        router.push({
                          pathname: '/admin/manage-job-post/permanent/list',
                        });
                      }}
                    >
                      Cancel
                      ...
                      <Col xs={24} lg={12}>
                        ...
                        >
                          <Dragger
                            ...
                            onSuccess={(data) => onSuccessDocumentsUploaded(data)}
                      ...
                      <Col xs={24} lg={12}>
                        ...
                        >
                          <Dragger
                            ...
                            onSuccess={(data) => onSuccessAdditionalDocumentsUpload(data)}
                              ...
                              <Row gutter={[16, 0]}>
                                <Col xs={24} lg={10}>
                                  ...
                                  >
                                    <Select
                                      ...
                                      getPopupContainer={(trigger) => trigger.parentNode}
                                      onChange={(value) => handleOnChangePosition(value, index, field.name)}
                                      disabled={allowEdit}
                                    >
                                      {positions &&
                                ...
                                <Col xs={24} lg={6}>
                                  <Form.Item
                                    ...
                                    fieldKey={[field.fieldKey, 'min_age']}
                                    label='Minimum Age'
                                    labelCol={{ span: 24 }}
                                  >
                                ...
                                <Col xs={24} lg={6}>
                                  <Form.Item
                                    ...
                                    fieldKey={[field.fieldKey, 'max_age']}
                                    label='Maximum Age'
                                    labelCol={{ span: 24 }}
                                  >
                                    <InputNumber disabled={allowEdit} />
                                ...
                                <Col xs={24} lg={4}>
                                  <Form.Item
                                    name={[field.name, 'monthly_emolements']}
                                    fieldKey={[field.fieldKey, 'monthly_emolements']}
                                    style={{ display: 'none' }}
                                  >
                                    <Input type='hidden' disabled={allowEdit} />
                                  </Form.Item>
                                  <Form.Item
                                    name={[field.name, 'number_of_vacancies']}
                                    fieldKey={[field.fieldKey, 'number_of_vacancies']}
                                ...
                                <Col span={24}>
                                  <Form.Item
                                    name={[field.name, 'documents_required']}
                                    fieldKey={[field.fieldKey, 'documents_required']}
                                ...
                                <Col span={24}>
                                  <Form.Item
                                    name={[field.name, 'information_required']}
                                    fieldKey={[field.fieldKey, 'information_required']}
                                ...
                                <Col span={24}>
                                  <Form.Item
                                    name={[field.name, 'extra_note']}
                                    fieldKey={[field.fieldKey, 'extra_note']}
                                ...
                                <Col span={24}>
                                  <Form.Item
                                    name={[field.name, 'qualification_job_history']}
                                    fieldKey={[field.fieldKey, 'qualification_job_history']}
...
export default JobPostPermanentUpdate;
