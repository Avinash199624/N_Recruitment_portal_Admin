            ...
            {loading ? (
              ...
              <Space direction='vertical' style={{ width: '100%' }}>
                ...
                <ListingStyles>
                  <Row>
                    <Col span={24}>
                      <Table dataSource={zonals} getPopupContainer={(trigger) => trigger.parentNode}>
                        <Column title='Sr.No' key='sr_no' dataIndex='sr_no' />
                        <Column
                          title='Zonal Name'
                          dataIndex='zonal_lab_name'
                          key='zonal_lab_name'
                          sorter={(a, b) => a.zonal_lab_name.localeCompare(b.zonal_lab_name)}
                          {...getColumnSearchProps('zonal_lab_name', 'Zonal Name')}
                        />
                        <Column
                          title='Action'
                          key='action'
