  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      setInitialState({
        ...
        qualification: getSavedIds('education_id', response.data.temp_position_master.qualification),
                ...
                <Row gutter={[16, 0]}>
                  ...
                  <Col xs={24} lg={4}>
                    <Form.Item label='Quota' labelCol={{ span: 24 }} name='quota'>
                      <Select
                        ...
                        defaultValue={initialState.temp_position_master.quota}
                  ...
                  <Col xs={24} lg={4}>
                    <Form.Item name='salary' label='Salary Amount' labelCol={{ span: 24 }}>
                      <InputNumber style={{ width: '100%' }} placeholder='Enter Salary' type='number' />
                    </Form.Item>
                  </Col>
                  <Col xs={24} lg={4}>
                    <Form.Item
