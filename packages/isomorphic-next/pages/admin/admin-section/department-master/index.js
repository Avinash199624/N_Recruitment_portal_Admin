...
import { Space, Row, Col, Popconfirm, message, Input, Tooltip, notification } from 'antd';
...
const DepartmentMaster = () => {
  ...
  const onConfirmDelete = async (id) => {
    const response = await client.delete(`/job_posting/division/${id}/ `);
            ...
            {loading ? (
              ...
              <Space direction='vertical' style={{ width: '100%' }}>
                ...
                <ListingStyles>
                  <Row>
                    <Col span={24}>
                      <Table dataSource={department} getPopupContainer={(trigger) => trigger.parentNode}>
                        ...
                        <Column
                          ...
                          {...getColumnSearchProps('division_name', 'Department Name')}
                        />
                        <Column
                          title='Action'
                          key='action'
