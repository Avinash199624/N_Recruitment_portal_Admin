...
const TopbarWrapper = styled.div`
  .isomorphicTopbar {
    ...
    padding: ${(props) => (props['data-rtl'] === 'rtl' ? '0 285px 0 31px' : '0 31px 0 285px')};
    z-index: 1000;
    ${transition()};
    box-shadow: 10px 2px 4px 0px rgb(0 0 0 / 5%)
    ...
    &.collapsed {
      padding: ${(props) => (props['data-rtl'] === 'rtl' ? '0 95px 0 31px' : '0 31px 0 95px')};
      @media only screen and (max-width: 767px) {
    ...
    .isoLeft {
      ...
      @media only screen and (max-width: 767px) {
        margin: ${(props) => (props['data-rtl'] === 'rtl' ? '0 0 0 20px' : '0 20px 0 5px')};
      }
